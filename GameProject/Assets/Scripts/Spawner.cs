...
public class Spawner : MonoBehaviour {
	...
	void SpawnPillar()
	{
		if (Application.loadedLevelName == "Level1"){
			...
			GameObject PillarClone = Instantiate (Pillar, new Vector3 (Random.Range (-8, 8), Random.Range (-5, 5), (PlayerShip.transform.position.z + 250)), Quaternion.Euler (0, 0, 0)) as GameObject;
		}
